...
GitHub: [lbyxunxunnini/h5-forge](https://github.com/lbyxunxunnini/h5-forge) · License: MIT · 当前版本：0.2.0
...
- H5/Web 项目内的新页面、新模块、结构调整、review、迁移、命名统一
...
这类话术会强制 h5-forge 从需求分析师阶段继续，而不是直接进入实现。

当你希望先讨论而不是让它自动收口，可以直接说：
...
如果这些决策会影响页面形态、路由、内容源、SEO 或主要交互，h5-forge 应先提 1-3 个关键问题，再继续 UI / 架构阶段。
...
当前版本：**0.2.0** · [CHANGELOG](CHANGELOG.md)
